...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = '[B][COLOR '+COLOR2+']The Teverz Wizard was built by Teverz. For any questions, concerns, suggestions and/or requests contact me on Twitter at: [/COLOR] [COLOR '+COLOR1+']@TeverzMe[/COLOR][/B]'
