...
def maintMenu(view=None):
	...
	addFile('Show [B]ALL[/B] [I][COLOR %s]([/COLOR]Teverz[COLOR %s])[/COLOR][/I]  Submenus: %s' % (COLOR1, COLOR1, maint.replace('true',on).replace('false',off)), 'togglesetting', 'showmaint', icon=ICONMAINT, themeit=THEME2)
...
def speedMenu():
	xbmc.executebuiltin('Runscript("special://home/addons/plugin.program.teverzwizard/speedtest.py")')
######################################################################################################################
