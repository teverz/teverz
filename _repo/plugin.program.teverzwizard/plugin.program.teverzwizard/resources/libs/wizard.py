...
def fixmetas():
	idlist = ['plugin.video.metalliq', 'plugin.video.chappaai','plugin.video.meta', 'script.renegadesmeta']
	temp   = os.path.join(PLUGIN, 'resources', 'tempaddon.xml')
	f      = open(temp, 'r'); r = f.read(); f.close()
	for item in idlist:
		fold = os.path.join(ADDONS, item)
...
DATA_API      = base64.b64decode(b'QUl6YVN5REViRnB3Q0pJUlBwRjBtSUJzVm15aDVHOXh6cEdxRW5V')
DATA_CLIENT   = base64.b64decode(b'MTQ5ODAxODMzOTcxLWVtYjc1NzBjczFkMzU3YjY4djE5NXU0YXM5ZzA2NjdwLmFwcHMuZ29vZ2xldXNlcmNvbnRlbnQuY29t')
DATA_SECRET   = base64.b64decode(b'RnUwOHcxYWMtZWw3R0I0UmtpYTVuRTJ6')
#######################################################################
