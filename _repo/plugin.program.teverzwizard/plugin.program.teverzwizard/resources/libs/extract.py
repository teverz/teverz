...
LOGFILES       = ['xbmc.log', 'xbmc.old.log', 'kodi.log', 'kodi.old.log', 'spmc.log', 'spmc.old.log', 'tvmc.log', 'tvmc.old.log', 'ftmc.log', 'ftmc.old.log', 'cemc.log', 'cemc.old.log', 'Thumbs.db', '.gitignore', '.DS_Store']
bad_files      = ['DEATHScache.db', 'DEATHScache.db-shm', 'DEATHScache.db-wal', 'onechannelcache.db', 'saltscache.db', 'saltscache.db-shm', 'saltscache.db-wal', 'saltshd.lite.db', 'saltshd.lite.db-shm', 'saltshd.lite.db-wal', 'saltsrd.lite.db', 'saltsrd.lite.db-shm', 'saltsrd.lite.db-wal', 'wtforkcache.db', 'wtforkcache.db-shm', 'wtforkcache.db-wal', 'UKTurk.db', 'queue.db', 'commoncache.db', 'access.log', 'trakt.db', 'video_cache.db']
...
def allWithProgress(_in, _out, dp, ignore, title):
	...
	for item in zin.infolist():
		...
		skip = False
		line1  = '[COLOR %s]%s [COLOR %s][B][Errors:%s][/B][/COLOR]' % (COLOR1, title, COLOR2, errors)
