...
ORDER          = ['exodus', 'covenant', 'poseidon', 'delorean', 'metalliq', 'salts', 'saltshd', 'saltsrd', 'dstreams', 'velocity', 'velocitykids', 'meta', 'royalwe', 'specto', 'trakt']
...
TRAKTID = { 
	...
	'dstreams': {
		...
		'file'     : os.path.join(TRAKTFOLD, 'dstreams_trakt'),
